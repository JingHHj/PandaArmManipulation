...
def get_opt():
    ...
    parser.add_argument("--env", type=int, default = 1, choices=[1,3,4],help="Environment Number, there's only 3 environments available")
    parser.add_argument("--planner", type=str, default="RRT_Real_Time", choices=["RRT", "RRT_Star", "RRT_Real_Time"],help="Motion Planner")
    parser.add_argument("--trial", type=int, default=3, help="Number of trials")
    parser.add_argument("--point_cloud_count", type=int, default=300, help="Number of points in the point cloud")
...
if __name__ == "__main__":
    ...
    point_cloud_count = opt.point_cloud_count
    env_num = opt.env
    planner = opt.planner
    trial = opt.trial
    print(f"Environment: {env_num}, Planner: {planner}, Trial: {trial}")
